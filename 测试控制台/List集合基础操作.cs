...
namespace 测试控制台
{
    class List集合基础操作
    {
        public static void c()
        {
            ...
            new stu{id=3,name="zs",age=1,pc=0},
            new stu{id=3,name="zs",age=1,pc=0},

            new stu{id=3,name="zs",age=2,pc=0},
            new stu{id=2,name="ls",age=2,pc=0},

            new stu{id=4,name="ls",age=3,pc=2},
            new stu{id=4,name="ls",age=3,pc=0},

            new stu{id=4,name="lr",age=4,pc=2},
            new stu{id=4,name="lr",age=4,pc=2},

            new stu{id=4,name="lr",age=5,pc=2}
            };
